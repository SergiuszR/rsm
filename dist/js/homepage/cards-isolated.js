// Isolated Cards Script - No Webflow interference
(function() {
    'use strict';
    
    console.log('[Isolated Cards] Starting...');
    ...
    function initCards() {
        ...
        if (!container) {
            console.log('[Isolated Cards] Container not found, skipping');
            return;
        }
        
        if (cards.length === 0) {
            console.log('[Isolated Cards] No cards found, skipping');
            return;
        }
        
        console.log('[Isolated Cards] Found', cards.length, 'cards, initializing...');
        ...
        console.log('[Isolated Cards] Initialization complete');
    }
